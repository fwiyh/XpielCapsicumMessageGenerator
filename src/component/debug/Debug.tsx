    ...
    return (
        <div className="row">
            <div className="col-4">
                ...
                <button type="button" className="btn btn-secondary">経路計算</button>
            </div>
            <div className="col-4">
                <NodeList key={"debug_min_cost_search_from"} defaultIndex={0} />
                <NodeList key={"debug_min_cost_search_to"} defaultIndex={1} />
                <button type="button" className="btn btn-secondary">最小コストのノード検索</button>
            </div>
            <div className="col-4">
                起点ノード
                ...
                <button type="button" className="btn btn-secondary">隣接N件経路計算</button>
            </div>
        </div>
    )
}